...
import com.codescan.admin.common.exception.Asserts;
import com.codescan.admin.modules.sys.dto.SysAdminParam;
import com.codescan.admin.modules.sys.mapper.SysAdminMapper;
...
import com.codescan.admin.domain.AdminUserDetails;
import com.codescan.admin.modules.sys.dto.UpdatePasswordParam;
import com.codescan.admin.modules.sys.mapper.SysAdminLoginLogMapper;
...
public class SysAdminServiceImpl extends ServiceImpl<SysAdminMapper, SysAdmin> implements SysAdminService {
    ...
    public SysAdmin register(SysAdminParam sysAdminParam) {
        ...
        //查询是否有相同用户名的用户
        QueryWrapper<SysAdmin> wrapper = new QueryWrapper<>();
        wrapper.lambda().eq(SysAdmin::getUsername, sysAdmin.getUsername());
