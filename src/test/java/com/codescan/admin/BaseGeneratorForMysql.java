...
public class BaseGeneratorForMysql {
    ...
    public static void main(String[] args) {
        ...
        String outputFilePath = System.getProperty("user.dir") + "/src/main/resources/generator/";
        ...
        gc.setBaseColumnList(false);// XML columnList 通用查询结果列
        gc.setAuthor("admin");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/element-admin-web?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        // 公共父类
        // strategy.setSuperControllerClass("com.hong.controller.BaseController");
        // 写于父类中的公共字段
